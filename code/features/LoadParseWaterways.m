function [S, S_raw, airspace, BoundingBox_wgs84] = LoadParseWaterways(iso_3166_2, varargin)
...
load(['output' filesep 'OSM_1_' iso_3166_2 '.mat'],'S_waterway');
S_raw = S_waterway; clear S_waterway;

% Filter to use line vectors
% http://download.geofabrik.de/osm-data-in-gis-formats-free.pdf
% 8101 = large river
% 8102 = smaller river or stream
% 8103 = artifical waterway
% 8104 = small drainage ditch or similar structure
% We don't filter based on code bceause of the polymerge() and minimum
% distance criteria
l = strcmp(S_raw.Geometry,'Line');
